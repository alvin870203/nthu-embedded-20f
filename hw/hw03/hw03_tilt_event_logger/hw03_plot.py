...
tilt = np.arange(0,sample,Ts) # tilt event signal vector; create n samples
...
for x in range(0, n):
    tilt_line = s.readline() # Read an echo string from K66F terminated with '\n'
    # print line
    tilt[x] = int(tilt_line)
